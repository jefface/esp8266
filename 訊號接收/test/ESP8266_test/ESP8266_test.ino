...
void createWebServer(int webtype)
{
  ...
  server.on("/setting", []() {
    ...
    server.on("/", []() {
      ...
      content += "<p>你好, 請按下面的按鈕來開啟貨關閉</p>";
      content += "<input type=\"button\" value=\"打開\" onclick=\"self.location.href='/led/on'\">";
      content += "<input type=\"button\" value=\"關閉\" onclick=\"self.location.href='/led/off'\">";
      content += "<br><br>";  //空一行
